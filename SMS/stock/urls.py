...
urlpatterns = [
    ...
    url(r'^brand/delete/(?P<pk>[-\w\d\s]+)/$',views.BrandDeleteView.as_view(),name='delete_brand'),
    url(r'^brand/update/(?P<pk>[-\w\d\s]+)/$',views.BrandUpdateView.as_view(),name='update_brand'),
    ...
    url(r'^corder/list/$',views.OrderFilterView,name='list_corder'),
]
